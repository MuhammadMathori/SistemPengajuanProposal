<div id="sidebar">
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                    <a href="{{ route('dashboard') }}" class='sidebar-link'>
                        <i class="bi bi-speedometer2"></i> <!-- cocok untuk dashboard -->
                        <span>Dashboard</span>
                    </a>
                </li>
                ...
                @if (Auth::user()->role == 'admin')
                    <li class="sidebar-item {{ request()->routeIs('dosen.*') ? 'active' : '' }}">
                        <a href="{{ route('dosen.index') }}" class='sidebar-link'>
                            <i class="bi bi-shield-lock"></i> <!-- cocok untuk role/permission -->
                            <span>Dosen</span>
                        </a>
                    </li>
                ...
                @if (Auth::user()->role != 'admin')
                    <li class="sidebar-item {{ request()->routeIs('proposal.*') ? 'active' : '' }}">
            ...
            <ul class="menu" style="position: absolute; bottom: 0; width: 100%;cursor: pointer;">
                <li class="sidebar-item">
                    <a class='sidebar-link' onclick="logoutAction();">
